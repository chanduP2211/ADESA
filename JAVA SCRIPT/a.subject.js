...
async function apiCalling(){
  let bodyData = {
     ...
     "faculty_name" : teacher_name.value,
  };
...
async function apiGetting(){
  ...
  subject.forEach((element)=>{
    data += `<tr><td>${++count}</td><td>${element.subject_name}</td><td>${element.faculty_name}</td><td class="td"><i class="fa-solid fa-user-pen update"></i><i class="fa-solid fa-trash delete"></i></td></tr>`;
  })
